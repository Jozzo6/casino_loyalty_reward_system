...
import (
	...
	"github.com/Jozzo6/casino_loyalty_reward_system/internal/http/notifications"
)

func main() {
	ctx := context.Background()
	log.Println("casino_loyalty_reward_system notifications api: starting server...")
	server, err := notifications.NewServer(ctx)
	if err != nil {
