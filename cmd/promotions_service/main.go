...
import (
	...
	"github.com/Jozzo6/casino_loyalty_reward_system/internal/http/promotions"
)

func main() {
	ctx := context.Background()
	log.Println("casino_loyalty_reward_system promotions api: starting server...")
	server, err := promotions.NewServer(ctx)
	if err != nil {
